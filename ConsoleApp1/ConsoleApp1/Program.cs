...
namespace DigitalSignatureApp
{
    class Program
    {
        ...
        // Hàm tính lũy thừa cơ số a^b % mod
        ...
        // Hàm ký số bản băm z bằng khóa bí mật (d, n)
        static long GenerateSignature(long z, long d, long n)
        {
            return ModPow(z, d, n);
        }

        // Hàm giải mã chữ ký số y bằng khóa công khai (e, n)
        ...
        static void Main(string[] args)
        {
            ...
            // Tạo khóa RSA ngay khi khởi chạy
            ...
            {
                Console.Clear();
                DisplayKeys(); // Hiển thị thông tin khóa RSA trước menu
                ...
                switch (choice)
                {
                    case 1:
                        ...
                        long z = Convert.ToInt64(hash.Substring(0, 15), 16) % n; // Lấy 15 ký tự đầu
