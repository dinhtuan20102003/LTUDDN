...
namespace Quanlysinhvien
{
    public partial class User : Form
    {
        ...
        private void User_Load(object sender, EventArgs e)
        {
            ketnoi();
            string sql;
            sql = "select tk[Tên Tài Khoản],mk[Mật Khẩu] from Nguoidung";
        ...
        private void btnthem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string query = "INSERT INTO NguoiDung (tk, mk) VALUES (@tk, @mk)";
                ...
                string sql = "SELECT tk AS [Tên Tài Khoản], mk AS [Mật Khẩu] FROM NguoiDung";
                DataSet ds = new DataSet();
                SqlDataAdapter sqlda = new SqlDataAdapter(sql, sqlcon);
                sqlda.Fill(ds);
        ...
        private void btnxoa_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    string s = "DELETE FROM NguoiDung WHERE tk = @tk";
