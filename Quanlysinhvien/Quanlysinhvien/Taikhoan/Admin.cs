...
namespace Quanlysinhvien
{
    public partial class Admin : Form
    {
        ...
        private void Admin_Load(object sender, EventArgs e)
        {
            ketnoi();
            string sql;
            sql = "select tk[Tên Tài Khoản],mk[Mật Khẩu] from Admin";
        ...
        private void btnthem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string query = "INSERT INTO Admin (tk, mk) VALUES (@tk, @mk)";
                using (SqlCommand sqlcom = new SqlCommand(query, sqlcon))
                {
                    sqlcom.Parameters.AddWithValue("@tk", taiKhoan);
                    sqlcom.Parameters.AddWithValue("@mk", hashedPassword);
        ...
        private void btnxoa_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    string s = "DELETE FROM Admin WHERE tk = @tk";
