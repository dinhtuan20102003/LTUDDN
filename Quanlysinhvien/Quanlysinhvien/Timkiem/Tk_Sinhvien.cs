...
namespace Quanlysinhvien.Timkiem
{
    public partial class Tk_Sinhvien : Form
    {
        ...
        private void btntim_Click(object sender, EventArgs e)
        {
            ...
            string tensv = "select count(*) from sinhvien where tensv like '%' + @tukhoa + '%'";
            tim = new SqlCommand(tensv, sqlcon);
            tim.Parameters.AddWithValue("@tukhoa", txttukhoa.Text);
            count = (int)tim.ExecuteScalar();

            if (count != 0 && cmbtimtheo.SelectedItem.ToString() == "Tên sinh viên")
            {
                kt = true;
            }
            ...
            if (kt)
            {
                ...
                string kq = "select *from sinhvien where tensv like '%' + @tukhoa + '%'";
            ...
            else
            {
                ...
                string diachi = "select count(*) from sinhvien where diachi like '%' + @tukhoa + '%'";
                ...
                if (kt1)
                {
                    ...
                    string kq = "select *from sinhvien where diachi like '%' + @tukhoa + '%'";
        ...
        {
            ketnoi();
            this.cmbtimtheo.Items.Add("Tên sinh viên");
